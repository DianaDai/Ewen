...
class questionmodel {
    ...
    var $ordertable = array(
        'all' => 'AND status!=0 ORDER BY shangjin DESC,hasvoice DESC, time DESC',
        ...
        '2' => ' AND status=2  ORDER BY shangjin DESC,hasvoice DESC, time DESC',
 ...
 function get_by_qid($qid) {
    ...
    function add($title, $description, $hidanswer, $price, $cid, $cid1 = 0, $cid2 = 0, $cid3 = 0, $status = 0,$shangjin=0,$askfromuid=0) {
        ...
        /* 分词索引 */
        $this->db->query("INSERT INTO " . DB_TABLEPRE . "question SET cid='$cid',cid1='$cid1',cid2='$cid2',cid3='$cid3',askuid='$askfromuid',authorid='$uid',shangjin='$shangjin',author='$username',title='$title',description='$description',price='$price',time='$creattime',endtime='$endtime',hidden='$hidanswer',status='$status',ip='{$this->base->ip}'");
