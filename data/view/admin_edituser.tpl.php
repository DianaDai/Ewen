...
<td class="altbg2">
<input class="radio" id="blackyes"  type="radio"  <? if($member['isblack']) { ?>checked<? } ?> value="1" name="isblack"><label for="blackyes">是</label>&nbsp;&nbsp;&nbsp;
<input class="radio" id="blackno"   type="radio" <? if(!$member['isblack']) { ?>checked<? } ?> value="0" name="isblack"><label for="blackno">否</label>
</td>
</tr>
<tr>
