...
<div class="ui-form ui-border-t">
        ...
        <input type="hidden"  id="forward" name="return_url" value="<?=$forward?>">
            ...
            <? if(!$iswxbrower) { ?>                 <div class="ui-form-item ui-form-item-r ui-border-b " style="margin-top:10px;">
                <input type="text" id="seccode_verify" name="seccode_verify" placeholder="请输入验证码">
              
                <button type="button" class="ui-border-l"><img class="ui-border-l" src="<?=SITE_URL?>user/code.html" onclick="javascript:updatecode();" id="verifycode"></button>
         ...
         <? if($user['uid']) { ?>            <div class="ui-form-item ui-form-item-switch ui-border-b">
                <p>
                    匿名提问
                </p>
...
var sv=$("#srchcategory").val();
 ...
 $.ajax({
        ...
        type:"POST",
        //提交的网址
        url:"<?=SITE_URL?>question/ajaxgetcat.html",
        //提交的数据
        data:{category:sv},
        //返回数据的格式
