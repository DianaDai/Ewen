...
<td width="7%" align="center" class="altbg2"><a href="<?=SITE_URL?>index.php?admin_nav/available/<?=$nav['id']?>/<?=$nav['available']?><?=$setting['seo_suffix']?>"><? if($nav['available']) { ?>点击禁用<? } else { ?><font color="green">点击启用</font><? } ?></a></td>
