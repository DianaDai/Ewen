...
<div class="user-home bg-white">
    ...
    <div class="row">
                 <div class="col-sm-12">
                     <div class="dongtai">
                         ...
                         <hr>
                       <form class="form-horizontal" action="<?=SITE_URL?>user/editxinzhi.html"  method="post" enctype="multipart/form-data">
  ...
  <? if(isset($topic['image'])) { ?>   <? $index=strpos($topic['image'],'http'); ?>                     <? if($index==0 ) { ?>                            
                           <img class="img-thumbnail" data-toggle="lightbox"  data-image="<?=$topic['image']?>" data-caption="<?=$topic['title']?>"  id="imghead" src="<?=$topic['image']?>" width="489" height="240"/>&nbsp;&nbsp;&nbsp;
                            <? } else { ?>                        <img class="img-thumbnail" data-toggle="lightbox"  data-image="<?=SITE_URL?><?=$topic['image']?>" data-caption="<?=$topic['title']?>"  id="imghead" src="<?=SITE_URL?><?=$topic['image']?>" width="489" height="240"/>&nbsp;&nbsp;&nbsp;
