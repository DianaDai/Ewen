...
<div class=" col-sm-4 ">
          <div class="card">
            ...
            <div  class="card-content text-muted">
              ...
              <? echo cutstr($gift['description'],80,''); ?>            </div>
   ...
   <? if($user['uid']) { ?>    
            <div class="row">
                <div class="col-sm-2 clearfix">
                  ...
                  <div class="col-sm-10">
                    <h3 class="font-15"><a target="_blank" href="<?=SITE_URL?>user/default.html"><?=$user['username']?></a></h3>
...
<? if(is_array($weekuserlist)) { foreach($weekuserlist as $index => $alluser) { ?>
                <? $index++; ?>                <li class="b-b-line">
                    ...
                    <a href="<?=SITE_URL?>u-<?=$alluser['uid']?>.html" target="_blank" onmouseover="pop_user_on(this, '<?=$alluser['uid']?>', 'text');"  onmouseout="pop_user_out();"> <?=$alluser['username']?> <span class="label  label-danger pull-right"><?=$alluser['credit2']?></span></a>
...
<? if(is_array($loglist)) { foreach($loglist as $giftlog) { ?>
                <p class="mar-t-03"><a href="<?=SITE_URL?>u-<?=$giftlog['uid']?>.html" target="_blank"><?=$giftlog['username']?></a> 刚刚兑换了礼品"<?=$giftlog['giftname']?>"</p>
...
<div class="modal-dialog">
  <div class="modal-content">
    ...
    <form class="form-horizontal" name="loginform"  action="<?=SITE_URL?>gift/add.html" method="post">
