<? if(!defined('IN_ASK2')) exit('Access Denied'); global $starttime,$querynum;$mtime = explode(' ', microtime());$runtime=number_format($mtime['1'] + $mtime['0'] - $starttime,6); $setting=$this->setting;$user=$this->user;$headernavlist=$this->nav;$regular=$this->regular; ?><div class="poploginform" id="taigerenter">
         ...
         <div class="form-group">
          ...
          <div class="col-md-4">
             <input type="text"  id="login_code" name="code" onblur="check_login_code();"  value="" class="form-control">
              ...
              <div class="col-md-2">
            <span class="verifycode"><img class="hand" src="<?=SITE_URL?>user/code.html" onclick="javascript:popupdatecode();" id="popverifycode">
                        </span>
          </div>
          <div class="col-md-2">
...
<!--            <a href="<?=SITE_URL?>user/getpass.html" class="text-danger mar-l-1">忘记密码?</a>-->
    ...
    <div id="being_login" style="width: 100%; text-align: center; display: none; position: relative">
        <p style="margin: 0px; padding: 0px;">
            正在登录...<p />
        <img src="<?=SITE_URL?>static/css/images/being_login.gif"/>
    </div>
    ...
    <script type="text/javascript">
        ...
        $(taigerenter).keyup(function(event){
            if(event.keyCode==13){
