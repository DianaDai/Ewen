...
<!--                    <img class="pull-right" src="<?=SITE_URL?>user/code.html" onclick="javascript:updatecode();" id="verifycode">
...
<!-- <span>还没有账号?</span>&nbsp;&nbsp; -->
<!-- <a href="<?=SITE_URL?>user/register.html">立即注册</a>&nbsp;&nbsp;•&nbsp;&nbsp; -->
<!-- <a href="<?=SITE_URL?>user/getpass.html">忘记密码</a>&nbsp;&nbsp;•&nbsp;&nbsp; -->
