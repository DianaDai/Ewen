...
</div><? if(isset($message)) { $type=isset($type)?$type:'correctmsg';  ?><div class="alert  alert-warning"><?=$message?></div><? } ?><form action="index.php?admin_setting/mail<?=$setting['seo_suffix']?>" method="post">
<table class="table">
<tr class="header">
