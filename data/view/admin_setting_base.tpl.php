...
<? } } ?>
           ...
           <tr>
            <td class="altbg1" width="45%"><b>PC端默认主题:</b><br>
                <span class="smalltxt">设置网站的前台的PC默认模板主题颜色</span></td>
            <td class="altbg2">
                <select name="tpl_themedir" >
                <option class="select" value="default" <? if('default'==$setting['tpl_themedir']) { ?> selected <? } ?> >default</option>
                    
<? if(is_array($themetpllist)) { foreach($themetpllist as $value) { ?>
                    <option class="select" value="<?=$value?>" <? if($value==$setting['tpl_themedir']) { ?> selected <? } ?> ><?=$value?></option>
...
<? } } ?>
        ...
        <tr>
          ...
          <tr>
            ...
            <td class="altbg2"><input type="text" class="form-control shortinput" value="<? if($setting['jingyan']<=0) { ?>0 <? } else { ?><?=$setting['jingyan']?><? } ?>" name="jingyan"></td>
        </tr>  
        <tr>
        ...
        <tr>
           ...
           <tr>
            ...
            <td class="altbg2">
                <input class="radio inline" type="radio" <? if(0==$setting['cancopy']) { ?>checked<? } ?> value="0" name="cancopy" >&nbsp;禁用&nbsp;&nbsp;
                       <input class="radio inline" type="radio" <? if(1==$setting['cancopy']) { ?>checked<? } ?> value="1" name="cancopy" >&nbsp;启用&nbsp;&nbsp;
